...
namespace PInvokeDx11Hook
{
    public class ImplDX11
    {
        ...
        [DllImport("cimgui", EntryPoint = "ImGui_ImplDX11_RenderDrawData", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RenderDrawData(ImDrawDataPtr drawData);

        [DllImport("cimgui", EntryPoint = "ImGui_ImplDX11_CreateDeviceObjects", CallingConvention = CallingConvention.Cdecl)]
